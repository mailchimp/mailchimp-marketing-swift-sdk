...
@Suite("Client Retry Tests") struct ClientRetryTests {
    @Test func testRetryOn408RequestTimeout() async throws {
        ...
        do {
            _ = try await client.root.list(requestOptions: RequestOptions(additionalHeaders: stub.headers))
    ...
    @Test func testEndpointLevelMaxRetriesOverride() async throws {
        ...
        do {
            _ = try await client.root.list(requestOptions: RequestOptions(maxRetries: 5, additionalHeaders: stub.headers))
    ...
    @Test func testEndpointLevelMaxRetriesZero() async throws {
        ...
        do {
            _ = try await client.root.list(requestOptions: RequestOptions(maxRetries: 0, additionalHeaders: stub.headers))
