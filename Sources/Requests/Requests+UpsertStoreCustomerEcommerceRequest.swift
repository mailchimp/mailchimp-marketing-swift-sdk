...
extension Requests {
    public struct UpsertStoreCustomerEcommerceRequest: Codable, Hashable, Sendable {
        /// The customer's address.
        public let address: UpsertStoreCustomerEcommerceRequestAddress?
        ...
        public let totalSpent: UpsertStoreCustomerEcommerceRequestTotalSpent?
        /// Additional properties that are not explicitly defined in the schema
        public let additionalProperties: [String: JSONValue]

        public init(
            address: UpsertStoreCustomerEcommerceRequestAddress? = nil,
            company: String? = nil,
            ...
            totalSpent: UpsertStoreCustomerEcommerceRequestTotalSpent? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.address = try container.decodeIfPresent(UpsertStoreCustomerEcommerceRequestAddress.self, forKey: .address)
            ...
            self.totalSpent = try container.decodeIfPresent(UpsertStoreCustomerEcommerceRequestTotalSpent.self, forKey: .totalSpent)
