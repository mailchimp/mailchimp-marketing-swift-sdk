...
extension Requests {
    public struct CreateStoreProductVariantEcommerceRequest: Codable, Hashable, Sendable {
        /// The backorders of a product variant.
        public let backorders: String?
        /// A unique identifier for the product variant.
        public let id: CreateStoreProductVariantEcommerceRequestId
        /// The image URL for a product variant.
        public let imageUrl: String?
        /// The inventory quantity of a product variant.
        public let inventoryQuantity: Int?
        public let price: CreateStoreProductVariantEcommerceRequestPrice?
        ...
        public init(
            ...
            price: CreateStoreProductVariantEcommerceRequestPrice? = nil,
            sku: String? = nil,
            title: String,
            url: String? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.id = try container.decode(CreateStoreProductVariantEcommerceRequestId.self, forKey: .id)
            self.imageUrl = try container.decodeIfPresent(String.self, forKey: .imageUrl)
            self.inventoryQuantity = try container.decodeIfPresent(Int.self, forKey: .inventoryQuantity)
            self.price = try container.decodeIfPresent(CreateStoreProductVariantEcommerceRequestPrice.self, forKey: .price)
