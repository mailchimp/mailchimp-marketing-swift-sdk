...
extension Requests {
    public struct UpdateListsRequest: Codable, Hashable, Sendable {
        /// [Default values for campaigns](https://mailchimp.com/help/edit-your-emails-subject-preview-text-from-name-or-from-email-address/) created for this list.
        public let campaignDefaults: UpdateListsRequestCampaignDefaults?
        /// [Contact information displayed in campaign footers](https://mailchimp.com/help/about-campaign-footers/) to comply with international spam laws.
        public let contact: UpdateListsRequestContact?
        ...
        public init(
            campaignDefaults: UpdateListsRequestCampaignDefaults? = nil,
            contact: UpdateListsRequestContact? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.campaignDefaults = try container.decodeIfPresent(UpdateListsRequestCampaignDefaults.self, forKey: .campaignDefaults)
            self.contact = try container.decodeIfPresent(UpdateListsRequestContact.self, forKey: .contact)
