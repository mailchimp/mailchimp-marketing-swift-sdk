...
extension Requests {
    public struct CreateStorePromoRulePromoCodeEcommerceRequest: Codable, Hashable, Sendable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.redemptionUrl = try container.decode(String.self, forKey: .redemptionUrl)
        ...
        public func encode(to encoder: Encoder) throws -> Void {
            ...
            try container.encode(self.redemptionUrl, forKey: .redemptionUrl)
