...
extension Requests {
    public struct CreateStoreOrderLineEcommerceRequest: Codable, Hashable, Sendable {
        public let discount: CreateStoreOrderLineEcommerceRequestDiscount?
        /// A unique identifier for the order line item.
        public let id: String
        public let price: CreateStoreOrderLineEcommerceRequestPrice
        ...
        public init(
            discount: CreateStoreOrderLineEcommerceRequestDiscount? = nil,
            id: String,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.discount = try container.decodeIfPresent(CreateStoreOrderLineEcommerceRequestDiscount.self, forKey: .discount)
            self.id = try container.decode(String.self, forKey: .id)
            self.price = try container.decode(CreateStoreOrderLineEcommerceRequestPrice.self, forKey: .price)
