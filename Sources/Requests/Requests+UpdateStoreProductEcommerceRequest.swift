...
extension Requests {
    public struct UpdateStoreProductEcommerceRequest: Codable, Hashable, Sendable {
        /// The description of a product.
        public let description: String?
        /// The handle of a product.
        public let handle: String?
        /// A unique identifier for the product.
        public let id: UpdateStoreProductEcommerceRequestId?
        /// The image URL for a product.
        public let imageUrl: String?
        /// An array of the product's images.
        public let images: [UpdateStoreProductEcommerceRequestImagesItem]?
        ...
        public let variants: [UpdateStoreProductEcommerceRequestVariantsItem]?
        ...
        public init(
            ...
            handle: String? = nil,
            id: UpdateStoreProductEcommerceRequestId? = nil,
            imageUrl: String? = nil,
            images: [UpdateStoreProductEcommerceRequestImagesItem]? = nil,
            publishedAtForeign: String? = nil,
            title: String? = nil,
            type: String? = nil,
            url: String? = nil,
            variants: [UpdateStoreProductEcommerceRequestVariantsItem]? = nil,
            vendor: String? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.id = try container.decodeIfPresent(UpdateStoreProductEcommerceRequestId.self, forKey: .id)
            self.imageUrl = try container.decodeIfPresent(String.self, forKey: .imageUrl)
            self.images = try container.decodeIfPresent([UpdateStoreProductEcommerceRequestImagesItem].self, forKey: .images)
            ...
            self.variants = try container.decodeIfPresent([UpdateStoreProductEcommerceRequestVariantsItem].self, forKey: .variants)
