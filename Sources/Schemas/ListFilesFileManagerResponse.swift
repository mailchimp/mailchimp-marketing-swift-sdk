...
public struct ListFilesFileManagerResponse: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [ListFilesFileManagerResponseLinksItem]?
    ...
    public init(
        links: [ListFilesFileManagerResponseLinksItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([ListFilesFileManagerResponseLinksItem].self, forKey: .links)
