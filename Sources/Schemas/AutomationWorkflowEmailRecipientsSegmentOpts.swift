...
public struct AutomationWorkflowEmailRecipientsSegmentOpts: Codable, Hashable, Sendable {
    public let conditions: SegmentType?
    /// Segment match type.
    public let match: AutomationWorkflowEmailRecipientsSegmentOptsMatch?
    /// The prebuilt segment id, if a prebuilt segment has been designated for this campaign.
    public let prebuiltSegmentId: String?
    /// The id for an existing saved segment.
    public let savedSegmentId: AutomationWorkflowEmailRecipientsSegmentOptsSavedSegmentId?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        conditions: SegmentType? = nil,
        match: AutomationWorkflowEmailRecipientsSegmentOptsMatch? = nil,
        prebuiltSegmentId: String? = nil,
        savedSegmentId: AutomationWorkflowEmailRecipientsSegmentOptsSavedSegmentId? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.match = try container.decodeIfPresent(AutomationWorkflowEmailRecipientsSegmentOptsMatch.self, forKey: .match)
        self.prebuiltSegmentId = try container.decodeIfPresent(String.self, forKey: .prebuiltSegmentId)
        self.savedSegmentId = try container.decodeIfPresent(AutomationWorkflowEmailRecipientsSegmentOptsSavedSegmentId.self, forKey: .savedSegmentId)
