...
public struct ListFoldersFileManagerResponseFoldersItemLinksItem: Codable, Hashable, Sendable {
    /// This property contains a fully-qualified URL that can be called to retrieve the linked resource or perform the linked action.
    public let href: String?
    /// The HTTP method that should be used when accessing the URL defined in 'href'.
    public let method: ListFoldersFileManagerResponseFoldersItemLinksItemMethod?
    ...
    public init(
        href: String? = nil,
        method: ListFoldersFileManagerResponseFoldersItemLinksItemMethod? = nil,
        rel: String? = nil,
        schema: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.method = try container.decodeIfPresent(ListFoldersFileManagerResponseFoldersItemLinksItemMethod.self, forKey: .method)
