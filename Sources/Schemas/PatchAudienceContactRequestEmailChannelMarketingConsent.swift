...
public struct PatchAudienceContactRequestEmailChannelMarketingConsent: Codable, Hashable, Sendable {
    /// The source from which the parent's entity was created.
    public let source: PatchAudienceContactRequestEmailChannelMarketingConsentSource?
    public let status: PatchAudienceContactRequestEmailChannelMarketingConsentStatus?
    ...
    public init(
        source: PatchAudienceContactRequestEmailChannelMarketingConsentSource? = nil,
        status: PatchAudienceContactRequestEmailChannelMarketingConsentStatus? = nil,
        capturedAt: Date? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.source = try container.decodeIfPresent(PatchAudienceContactRequestEmailChannelMarketingConsentSource.self, forKey: .source)
        self.status = try container.decodeIfPresent(PatchAudienceContactRequestEmailChannelMarketingConsentStatus.self, forKey: .status)
