...
public struct EmailActivity: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [EmailActivityLinksItem]?
    ...
    public let activity: [EmailActivityActivityItem]?
    ...
    public init(
        links: [EmailActivityLinksItem]? = nil,
        activity: [EmailActivityActivityItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([EmailActivityLinksItem].self, forKey: .links)
        self.activity = try container.decodeIfPresent([EmailActivityActivityItem].self, forKey: .activity)
