...
public struct AutomationWorkflowEmailTriggerSettings: Codable, Hashable, Sendable {
    /// A workflow's runtime settings for an Automation.
    public let runtime: AutomationWorkflowEmailTriggerSettingsRuntime?
    ...
    public let workflowType: AutomationWorkflowEmailTriggerSettingsWorkflowType
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        runtime: AutomationWorkflowEmailTriggerSettingsRuntime? = nil,
        workflowEmailsCount: Int? = nil,
        workflowTitle: String? = nil,
        workflowType: AutomationWorkflowEmailTriggerSettingsWorkflowType,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.runtime = try container.decodeIfPresent(AutomationWorkflowEmailTriggerSettingsRuntime.self, forKey: .runtime)
        ...
        self.workflowType = try container.decode(AutomationWorkflowEmailTriggerSettingsWorkflowType.self, forKey: .workflowType)
