...
public struct ECommerceStoreAutomationsAbandonedBrowse: Codable, Hashable, Sendable {
    ...
    public let status: ECommerceStoreAutomationsAbandonedBrowseStatus?
    ...
    public init(
        ...
        status: ECommerceStoreAutomationsAbandonedBrowseStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(ECommerceStoreAutomationsAbandonedBrowseStatus.self, forKey: .status)
