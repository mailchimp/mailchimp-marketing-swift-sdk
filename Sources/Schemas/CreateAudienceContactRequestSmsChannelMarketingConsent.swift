...
public struct CreateAudienceContactRequestSmsChannelMarketingConsent: Codable, Hashable, Sendable {
    /// The source from which the parent's entity was created.
    public let source: CreateAudienceContactRequestSmsChannelMarketingConsentSource?
    ...
    public let status: CreateAudienceContactRequestSmsChannelMarketingConsentStatus?
    ...
    public init(
        source: CreateAudienceContactRequestSmsChannelMarketingConsentSource? = nil,
        status: CreateAudienceContactRequestSmsChannelMarketingConsentStatus? = nil,
        capturedAt: Date? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.source = try container.decodeIfPresent(CreateAudienceContactRequestSmsChannelMarketingConsentSource.self, forKey: .source)
        self.status = try container.decodeIfPresent(CreateAudienceContactRequestSmsChannelMarketingConsentStatus.self, forKey: .status)
