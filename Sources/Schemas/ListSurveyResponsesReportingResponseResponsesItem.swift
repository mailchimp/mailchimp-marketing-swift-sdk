...
public struct ListSurveyResponsesReportingResponseResponsesItem: Codable, Hashable, Sendable {
    /// Information about the contact.
    public let contact: ListSurveyResponsesReportingResponseResponsesItemContact?
    ...
    public init(
        contact: ListSurveyResponsesReportingResponseResponsesItemContact? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.contact = try container.decodeIfPresent(ListSurveyResponsesReportingResponseResponsesItemContact.self, forKey: .contact)
