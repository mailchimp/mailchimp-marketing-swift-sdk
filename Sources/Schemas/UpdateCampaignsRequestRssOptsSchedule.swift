...
public struct UpdateCampaignsRequestRssOptsSchedule: Codable, Hashable, Sendable {
    /// The days of the week to send a daily RSS Campaign.
    public let dailySend: UpdateCampaignsRequestRssOptsScheduleDailySend?
    ...
    public let weeklySendDay: UpdateCampaignsRequestRssOptsScheduleWeeklySendDay?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        dailySend: UpdateCampaignsRequestRssOptsScheduleDailySend? = nil,
        hour: Int? = nil,
        monthlySendDate: Double? = nil,
        weeklySendDay: UpdateCampaignsRequestRssOptsScheduleWeeklySendDay? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dailySend = try container.decodeIfPresent(UpdateCampaignsRequestRssOptsScheduleDailySend.self, forKey: .dailySend)
        ...
        self.weeklySendDay = try container.decodeIfPresent(UpdateCampaignsRequestRssOptsScheduleWeeklySendDay.self, forKey: .weeklySendDay)
