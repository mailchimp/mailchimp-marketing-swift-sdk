...
/// The store address.
public struct CreateStoreEcommerceRequestAddress: Codable, Hashable, Sendable {
    ...
    public let latitude: CreateStoreEcommerceRequestAddressLatitude?
    /// The longitude of the store location.
    public let longitude: CreateStoreEcommerceRequestAddressLongitude?
    ...
    public init(
        ...
        latitude: CreateStoreEcommerceRequestAddressLatitude? = nil,
        longitude: CreateStoreEcommerceRequestAddressLongitude? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.latitude = try container.decodeIfPresent(CreateStoreEcommerceRequestAddressLatitude.self, forKey: .latitude)
        self.longitude = try container.decodeIfPresent(CreateStoreEcommerceRequestAddressLongitude.self, forKey: .longitude)
