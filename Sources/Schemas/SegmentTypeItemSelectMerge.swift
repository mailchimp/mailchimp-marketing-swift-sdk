...
public struct SegmentTypeItemSelectMerge: Codable, Hashable, Sendable {
    /// A merge field to segment.
    public let field: String
    /// Whether the member's merge information is/is not a value or is/is not blank.
    public let op: SegmentTypeItemSelectMergeOp
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.op = try container.decode(SegmentTypeItemSelectMergeOp.self, forKey: .op)
