...
public struct CampaignReportDeliveryStatus: Codable, Hashable, Sendable {
    ...
    public let status: CampaignReportDeliveryStatusStatus?
    ...
    public init(
        ...
        emailsSent: Int? = nil,
        enabled: Bool? = nil,
        status: CampaignReportDeliveryStatusStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(CampaignReportDeliveryStatusStatus.self, forKey: .status)
