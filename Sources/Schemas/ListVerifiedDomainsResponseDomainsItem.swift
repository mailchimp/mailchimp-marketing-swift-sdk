...
public struct ListVerifiedDomainsResponseDomainsItem: Codable, Hashable, Sendable {
    ...
    public let status: ListVerifiedDomainsResponseDomainsItemStatus?
    ...
    public init(
        ...
        status: ListVerifiedDomainsResponseDomainsItemStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(ListVerifiedDomainsResponseDomainsItemStatus.self, forKey: .status)
