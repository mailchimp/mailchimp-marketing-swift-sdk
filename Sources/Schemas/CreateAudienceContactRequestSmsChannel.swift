...
public struct CreateAudienceContactRequestSmsChannel: Codable, Hashable, Sendable {
    ...
    public let marketingConsent: CreateAudienceContactRequestSmsChannelMarketingConsent?
    /// SMS Phone Number
    ...
    public init(
        marketingConsent: CreateAudienceContactRequestSmsChannelMarketingConsent? = nil,
        smsPhone: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.marketingConsent = try container.decodeIfPresent(CreateAudienceContactRequestSmsChannelMarketingConsent.self, forKey: .marketingConsent)
