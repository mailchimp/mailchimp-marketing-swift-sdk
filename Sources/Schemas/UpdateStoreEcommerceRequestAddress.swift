...
/// The store address.
public struct UpdateStoreEcommerceRequestAddress: Codable, Hashable, Sendable {
    ...
    public let latitude: UpdateStoreEcommerceRequestAddressLatitude?
    /// The longitude of the store location.
    public let longitude: UpdateStoreEcommerceRequestAddressLongitude?
    ...
    public init(
        ...
        latitude: UpdateStoreEcommerceRequestAddressLatitude? = nil,
        longitude: UpdateStoreEcommerceRequestAddressLongitude? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.latitude = try container.decodeIfPresent(UpdateStoreEcommerceRequestAddressLatitude.self, forKey: .latitude)
        self.longitude = try container.decodeIfPresent(UpdateStoreEcommerceRequestAddressLongitude.self, forKey: .longitude)
