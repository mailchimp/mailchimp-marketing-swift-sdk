...
/// Audience settings
public struct FacebookAdsAudience: Codable, Hashable, Sendable {
    public let emailSource: FacebookAdsAudienceEmailSource?
    ...
    public let sourceType: FacebookAdsAudienceSourceType?
    public let targetingSpecs: FacebookAdsAudienceTargetingSpecs?
    /// Type of the audience
    public let type: FacebookAdsAudienceType?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        emailSource: FacebookAdsAudienceEmailSource? = nil,
        includeSourceInTarget: Bool? = nil,
        lookalikeCountryCode: String? = nil,
        sourceType: FacebookAdsAudienceSourceType? = nil,
        targetingSpecs: FacebookAdsAudienceTargetingSpecs? = nil,
        type: FacebookAdsAudienceType? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.emailSource = try container.decodeIfPresent(FacebookAdsAudienceEmailSource.self, forKey: .emailSource)
        ...
        self.sourceType = try container.decodeIfPresent(FacebookAdsAudienceSourceType.self, forKey: .sourceType)
        self.targetingSpecs = try container.decodeIfPresent(FacebookAdsAudienceTargetingSpecs.self, forKey: .targetingSpecs)
        self.type = try container.decodeIfPresent(FacebookAdsAudienceType.self, forKey: .type)
