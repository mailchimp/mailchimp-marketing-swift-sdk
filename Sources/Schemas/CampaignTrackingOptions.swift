...
public struct CampaignTrackingOptions: Codable, Hashable, Sendable {
    /// Deprecated
    public let capsule: CampaignTrackingOptionsCapsule?
    ...
    /// Deprecated
    public let salesforce: CampaignTrackingOptionsSalesforce?
    ...
    public init(
        capsule: CampaignTrackingOptionsCapsule? = nil,
        ...
        htmlClicks: Bool? = nil,
        opens: Bool? = nil,
        salesforce: CampaignTrackingOptionsSalesforce? = nil,
        textClicks: Bool? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.capsule = try container.decodeIfPresent(CampaignTrackingOptionsCapsule.self, forKey: .capsule)
        ...
        self.salesforce = try container.decodeIfPresent(CampaignTrackingOptionsSalesforce.self, forKey: .salesforce)
