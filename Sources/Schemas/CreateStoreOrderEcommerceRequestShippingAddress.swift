...
public struct CreateStoreOrderEcommerceRequestShippingAddress: Codable, Hashable, Sendable {
    /// The shipping address for the order.
    ...
    public let latitude: CreateStoreOrderEcommerceRequestShippingAddressLatitude?
    /// The longitude for the shipping address location.
    public let longitude: CreateStoreOrderEcommerceRequestShippingAddressLongitude?
    ...
    public init(
        ...
        latitude: CreateStoreOrderEcommerceRequestShippingAddressLatitude? = nil,
        longitude: CreateStoreOrderEcommerceRequestShippingAddressLongitude? = nil,
        name: String? = nil,
        phone: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.latitude = try container.decodeIfPresent(CreateStoreOrderEcommerceRequestShippingAddressLatitude.self, forKey: .latitude)
        self.longitude = try container.decodeIfPresent(CreateStoreOrderEcommerceRequestShippingAddressLongitude.self, forKey: .longitude)
