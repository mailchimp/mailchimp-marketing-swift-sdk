...
public struct CreateStoreOrderEcommerceRequestBillingAddress: Codable, Hashable, Sendable {
    /// The billing address for the order.
    ...
    public let latitude: CreateStoreOrderEcommerceRequestBillingAddressLatitude?
    /// The longitude for the billing address location.
    public let longitude: CreateStoreOrderEcommerceRequestBillingAddressLongitude?
    ...
    public init(
        ...
        latitude: CreateStoreOrderEcommerceRequestBillingAddressLatitude? = nil,
        longitude: CreateStoreOrderEcommerceRequestBillingAddressLongitude? = nil,
        name: String? = nil,
        phone: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.latitude = try container.decodeIfPresent(CreateStoreOrderEcommerceRequestBillingAddressLatitude.self, forKey: .latitude)
        self.longitude = try container.decodeIfPresent(CreateStoreOrderEcommerceRequestBillingAddressLongitude.self, forKey: .longitude)
