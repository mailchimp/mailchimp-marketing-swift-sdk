...
public struct CampaignRssOptsSchedule: Codable, Hashable, Sendable {
    /// The days of the week to send a daily RSS Campaign.
    public let dailySend: CampaignRssOptsScheduleDailySend?
    ...
    public let weeklySendDay: CampaignRssOptsScheduleWeeklySendDay?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        dailySend: CampaignRssOptsScheduleDailySend? = nil,
        hour: Int? = nil,
        monthlySendDate: Double? = nil,
        weeklySendDay: CampaignRssOptsScheduleWeeklySendDay? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dailySend = try container.decodeIfPresent(CampaignRssOptsScheduleDailySend.self, forKey: .dailySend)
        ...
        self.weeklySendDay = try container.decodeIfPresent(CampaignRssOptsScheduleWeeklySendDay.self, forKey: .weeklySendDay)
