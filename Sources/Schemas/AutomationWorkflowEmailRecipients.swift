...
public struct AutomationWorkflowEmailRecipients: Codable, Hashable, Sendable {
    /// The unique list id.
    ...
    public let segmentOpts: AutomationWorkflowEmailRecipientsSegmentOpts?
    ...
    public init(
        ...
        segmentOpts: AutomationWorkflowEmailRecipientsSegmentOpts? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.segmentOpts = try container.decodeIfPresent(AutomationWorkflowEmailRecipientsSegmentOpts.self, forKey: .segmentOpts)
