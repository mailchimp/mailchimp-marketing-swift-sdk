...
public struct GetSurveyResponsReportingResponseContact: Codable, Hashable, Sendable {
    ...
    public let status: GetSurveyResponsReportingResponseContactStatus?
    ...
    public init(
        ...
        fullName: String? = nil,
        phone: String? = nil,
        status: GetSurveyResponsReportingResponseContactStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(GetSurveyResponsReportingResponseContactStatus.self, forKey: .status)
