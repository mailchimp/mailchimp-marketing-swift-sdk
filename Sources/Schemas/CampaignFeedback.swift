...
public struct CampaignFeedback: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [CampaignFeedbackLinksItem]?
    ...
    public let source: CampaignFeedbackSource?
    ...
    public init(
        links: [CampaignFeedbackLinksItem]? = nil,
        blockId: Int? = nil,
        ...
        message: String? = nil,
        parentId: Int? = nil,
        source: CampaignFeedbackSource? = nil,
        updatedAt: Date? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([CampaignFeedbackLinksItem].self, forKey: .links)
        ...
        self.source = try container.decodeIfPresent(CampaignFeedbackSource.self, forKey: .source)
