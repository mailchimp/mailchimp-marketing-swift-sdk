...
public struct UpdateFolderFileManagerResponse: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [UpdateFolderFileManagerResponseLinksItem]?
    ...
    public init(
        links: [UpdateFolderFileManagerResponseLinksItem]? = nil,
        createdAt: Date? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([UpdateFolderFileManagerResponseLinksItem].self, forKey: .links)
