...
public struct UpdateCampaignsRequestVariateSettings: Codable, Hashable, Sendable {
    ...
    public let sendTimes: [UpdateCampaignsRequestVariateSettingsSendTimesItem]?
    ...
    public let winnerCriteria: UpdateCampaignsRequestVariateSettingsWinnerCriteria?
    ...
    public init(
        ...
        sendTimes: [UpdateCampaignsRequestVariateSettingsSendTimesItem]? = nil,
        subjectLines: [String]? = nil,
        testSize: Int? = nil,
        waitTime: Int? = nil,
        winnerCriteria: UpdateCampaignsRequestVariateSettingsWinnerCriteria? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.sendTimes = try container.decodeIfPresent([UpdateCampaignsRequestVariateSettingsSendTimesItem].self, forKey: .sendTimes)
        ...
        self.winnerCriteria = try container.decodeIfPresent(UpdateCampaignsRequestVariateSettingsWinnerCriteria.self, forKey: .winnerCriteria)
