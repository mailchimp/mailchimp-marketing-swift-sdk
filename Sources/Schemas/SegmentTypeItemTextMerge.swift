...
public struct SegmentTypeItemTextMerge: Codable, Hashable, Sendable {
    ...
    public let op: SegmentTypeItemTextMergeOp
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.op = try container.decode(SegmentTypeItemTextMergeOp.self, forKey: .op)
