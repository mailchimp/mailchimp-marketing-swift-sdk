...
public struct UpdateStoreOrderEcommerceRequestShippingAddress: Codable, Hashable, Sendable {
    /// The shipping address for the order.
    ...
    public let latitude: UpdateStoreOrderEcommerceRequestShippingAddressLatitude?
    /// The longitude for the shipping address location.
    public let longitude: UpdateStoreOrderEcommerceRequestShippingAddressLongitude?
    ...
    public init(
        ...
        latitude: UpdateStoreOrderEcommerceRequestShippingAddressLatitude? = nil,
        longitude: UpdateStoreOrderEcommerceRequestShippingAddressLongitude? = nil,
        name: String? = nil,
        phone: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.latitude = try container.decodeIfPresent(UpdateStoreOrderEcommerceRequestShippingAddressLatitude.self, forKey: .latitude)
        self.longitude = try container.decodeIfPresent(UpdateStoreOrderEcommerceRequestShippingAddressLongitude.self, forKey: .longitude)
