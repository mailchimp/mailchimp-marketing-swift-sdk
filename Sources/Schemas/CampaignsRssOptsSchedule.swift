...
public struct CampaignsRssOptsSchedule: Codable, Hashable, Sendable {
    /// The days of the week to send a daily RSS Campaign.
    public let dailySend: CampaignsRssOptsScheduleDailySend?
    ...
    public let weeklySendDay: CampaignsRssOptsScheduleWeeklySendDay?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        dailySend: CampaignsRssOptsScheduleDailySend? = nil,
        hour: Int? = nil,
        monthlySendDate: Double? = nil,
        weeklySendDay: CampaignsRssOptsScheduleWeeklySendDay? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dailySend = try container.decodeIfPresent(CampaignsRssOptsScheduleDailySend.self, forKey: .dailySend)
        ...
        self.weeklySendDay = try container.decodeIfPresent(CampaignsRssOptsScheduleWeeklySendDay.self, forKey: .weeklySendDay)
