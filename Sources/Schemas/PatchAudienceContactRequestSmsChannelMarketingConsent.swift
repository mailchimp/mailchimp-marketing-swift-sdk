...
public struct PatchAudienceContactRequestSmsChannelMarketingConsent: Codable, Hashable, Sendable {
    /// The source from which the parent's entity was created.
    public let source: PatchAudienceContactRequestSmsChannelMarketingConsentSource?
    ...
    public let status: PatchAudienceContactRequestSmsChannelMarketingConsentStatus?
    ...
    public init(
        source: PatchAudienceContactRequestSmsChannelMarketingConsentSource? = nil,
        status: PatchAudienceContactRequestSmsChannelMarketingConsentStatus? = nil,
        capturedAt: Date? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.source = try container.decodeIfPresent(PatchAudienceContactRequestSmsChannelMarketingConsentSource.self, forKey: .source)
        self.status = try container.decodeIfPresent(PatchAudienceContactRequestSmsChannelMarketingConsentStatus.self, forKey: .status)
