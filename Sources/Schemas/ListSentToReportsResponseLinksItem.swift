...
public struct ListSentToReportsResponseLinksItem: Codable, Hashable, Sendable {
    /// This property contains a fully-qualified URL that can be called to retrieve the linked resource or perform the linked action.
    public let href: String?
    /// The HTTP method that should be used when accessing the URL defined in 'href'.
    public let method: ListSentToReportsResponseLinksItemMethod?
    ...
    public init(
        href: String? = nil,
        method: ListSentToReportsResponseLinksItemMethod? = nil,
        rel: String? = nil,
        schema: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.method = try container.decodeIfPresent(ListSentToReportsResponseLinksItemMethod.self, forKey: .method)
