...
public struct CampaignsRecipients: Codable, Hashable, Sendable {
    /// The unique list id.
    ...
    public let segmentOpts: CampaignsRecipientsSegmentOpts?
    ...
    public init(
        ...
        segmentOpts: CampaignsRecipientsSegmentOpts? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.segmentOpts = try container.decodeIfPresent(CampaignsRecipientsSegmentOpts.self, forKey: .segmentOpts)
