...
public struct GetVerifiedDomainsResponse: Codable, Hashable, Sendable {
    ...
    public let status: GetVerifiedDomainsResponseStatus?
    ...
    public init(
        ...
        status: GetVerifiedDomainsResponseStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(GetVerifiedDomainsResponseStatus.self, forKey: .status)
