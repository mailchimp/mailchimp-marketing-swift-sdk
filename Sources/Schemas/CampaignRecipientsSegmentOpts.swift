...
public struct CampaignRecipientsSegmentOpts: Codable, Hashable, Sendable {
    public let conditions: SegmentType?
    /// Segment match type.
    public let match: CampaignRecipientsSegmentOptsMatch?
    /// The prebuilt segment id, if a prebuilt segment has been designated for this campaign.
    public let prebuiltSegmentId: String?
    /// The id for an existing saved segment.
    public let savedSegmentId: CampaignRecipientsSegmentOptsSavedSegmentId?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        conditions: SegmentType? = nil,
        match: CampaignRecipientsSegmentOptsMatch? = nil,
        prebuiltSegmentId: String? = nil,
        savedSegmentId: CampaignRecipientsSegmentOptsSavedSegmentId? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.match = try container.decodeIfPresent(CampaignRecipientsSegmentOptsMatch.self, forKey: .match)
        self.prebuiltSegmentId = try container.decodeIfPresent(String.self, forKey: .prebuiltSegmentId)
        self.savedSegmentId = try container.decodeIfPresent(CampaignRecipientsSegmentOptsSavedSegmentId.self, forKey: .savedSegmentId)
