...
public struct ListReportsResponse: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [ListReportsResponseLinksItem]?
    ...
    public init(
        links: [ListReportsResponseLinksItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([ListReportsResponseLinksItem].self, forKey: .links)
