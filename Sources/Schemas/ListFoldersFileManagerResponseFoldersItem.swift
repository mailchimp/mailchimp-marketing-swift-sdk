...
public struct ListFoldersFileManagerResponseFoldersItem: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [ListFoldersFileManagerResponseFoldersItemLinksItem]?
    ...
    public init(
        links: [ListFoldersFileManagerResponseFoldersItemLinksItem]? = nil,
        createdAt: Date? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([ListFoldersFileManagerResponseFoldersItemLinksItem].self, forKey: .links)
