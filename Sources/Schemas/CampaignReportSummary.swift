...
public struct CampaignReportSummary: Codable, Hashable, Sendable {
    /// The number of unique clicks divided by the total number of successful deliveries.
    public let clickRate: Double?
    /// The total number of clicks for an campaign.
    public let clicks: Int?
    /// E-Commerce stats for a campaign.
    public let ecommerce: CampaignReportSummaryEcommerce?
    ...
    public init(
        ...
        clicks: Int? = nil,
        ecommerce: CampaignReportSummaryEcommerce? = nil,
        openRate: Double? = nil,
        opens: Int? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.ecommerce = try container.decodeIfPresent(CampaignReportSummaryEcommerce.self, forKey: .ecommerce)
