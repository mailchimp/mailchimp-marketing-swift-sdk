...
public struct UpdateSegmentListsRequestOptions: Codable, Hashable, Sendable {
    public let conditions: SegmentType?
    /// Match type.
    public let match: UpdateSegmentListsRequestOptionsMatch?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        conditions: SegmentType? = nil,
        match: UpdateSegmentListsRequestOptionsMatch? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.match = try container.decodeIfPresent(UpdateSegmentListsRequestOptionsMatch.self, forKey: .match)
