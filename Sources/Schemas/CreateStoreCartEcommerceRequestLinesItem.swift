...
public struct CreateStoreCartEcommerceRequestLinesItem: Codable, Hashable, Sendable {
    /// A unique identifier for the cart line item.
    public let id: String
    public let price: CreateStoreCartEcommerceRequestLinesItemPrice
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.price = try container.decode(CreateStoreCartEcommerceRequestLinesItemPrice.self, forKey: .price)
