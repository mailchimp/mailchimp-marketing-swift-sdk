...
public struct EcommerceStoresOrdersPostVariantsItem: Codable, Hashable, Sendable {
    /// The backorders of a product variant.
    public let backorders: String?
    /// A unique identifier for the product variant.
    public let id: EcommerceStoresOrdersPostVariantsItemId
    /// The image URL for a product variant.
    public let imageUrl: String?
    /// The inventory quantity of a product variant.
    public let inventoryQuantity: Int?
    public let price: EcommerceStoresOrdersPostVariantsItemPrice?
    ...
    public init(
        ...
        price: EcommerceStoresOrdersPostVariantsItemPrice? = nil,
        sku: String? = nil,
        title: String,
        url: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.id = try container.decode(EcommerceStoresOrdersPostVariantsItemId.self, forKey: .id)
        self.imageUrl = try container.decodeIfPresent(String.self, forKey: .imageUrl)
        self.inventoryQuantity = try container.decodeIfPresent(Int.self, forKey: .inventoryQuantity)
        self.price = try container.decodeIfPresent(EcommerceStoresOrdersPostVariantsItemPrice.self, forKey: .price)
