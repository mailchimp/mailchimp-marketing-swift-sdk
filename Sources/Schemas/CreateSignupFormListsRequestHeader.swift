...
public struct CreateSignupFormListsRequestHeader: Codable, Hashable, Sendable {
    /// Image alignment.
    public let imageAlign: CreateSignupFormListsRequestHeaderImageAlign?
    /// Alt text for the image.
    public let imageAlt: String?
    /// Image border color.
    public let imageBorderColor: String?
    /// Image border style.
    public let imageBorderStyle: CreateSignupFormListsRequestHeaderImageBorderStyle?
    /// Image border width.
    ...
    /// Image link target.
    public let imageTarget: CreateSignupFormListsRequestHeaderImageTarget?
    /// Header image URL.
    ...
    public init(
        imageAlign: CreateSignupFormListsRequestHeaderImageAlign? = nil,
        imageAlt: String? = nil,
        imageBorderColor: String? = nil,
        imageBorderStyle: CreateSignupFormListsRequestHeaderImageBorderStyle? = nil,
        imageBorderWidth: String? = nil,
        imageHeight: String? = nil,
        imageLink: String? = nil,
        imageTarget: CreateSignupFormListsRequestHeaderImageTarget? = nil,
        imageUrl: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.imageAlign = try container.decodeIfPresent(CreateSignupFormListsRequestHeaderImageAlign.self, forKey: .imageAlign)
        ...
        self.imageBorderStyle = try container.decodeIfPresent(CreateSignupFormListsRequestHeaderImageBorderStyle.self, forKey: .imageBorderStyle)
        ...
        self.imageTarget = try container.decodeIfPresent(CreateSignupFormListsRequestHeaderImageTarget.self, forKey: .imageTarget)
