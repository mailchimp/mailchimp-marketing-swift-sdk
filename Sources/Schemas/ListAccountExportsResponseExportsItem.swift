...
/// An account export.
public struct ListAccountExportsResponseExportsItem: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [ListAccountExportsResponseExportsItemLinksItem]?
    ...
    public init(
        links: [ListAccountExportsResponseExportsItemLinksItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([ListAccountExportsResponseExportsItemLinksItem].self, forKey: .links)
