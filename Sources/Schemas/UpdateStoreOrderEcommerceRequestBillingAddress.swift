...
public struct UpdateStoreOrderEcommerceRequestBillingAddress: Codable, Hashable, Sendable {
    /// The billing address for the order.
    ...
    public let latitude: UpdateStoreOrderEcommerceRequestBillingAddressLatitude?
    /// The longitude for the billing address location.
    public let longitude: UpdateStoreOrderEcommerceRequestBillingAddressLongitude?
    ...
    public init(
        ...
        latitude: UpdateStoreOrderEcommerceRequestBillingAddressLatitude? = nil,
        longitude: UpdateStoreOrderEcommerceRequestBillingAddressLongitude? = nil,
        name: String? = nil,
        phone: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.latitude = try container.decodeIfPresent(UpdateStoreOrderEcommerceRequestBillingAddressLatitude.self, forKey: .latitude)
        self.longitude = try container.decodeIfPresent(UpdateStoreOrderEcommerceRequestBillingAddressLongitude.self, forKey: .longitude)
