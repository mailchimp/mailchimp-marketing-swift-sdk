...
public struct ListSurveysReportingResponseSurveysItem: Codable, Hashable, Sendable {
    ...
    /// The survey's status.
    public let status: ListSurveysReportingResponseSurveysItemStatus?
    ...
    public init(
        ...
        status: ListSurveysReportingResponseSurveysItemStatus? = nil,
        title: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(ListSurveysReportingResponseSurveysItemStatus.self, forKey: .status)
