...
public struct CreateVerifiedDomainsResponse: Codable, Hashable, Sendable {
    ...
    public let status: CreateVerifiedDomainsResponseStatus?
    ...
    public init(
        ...
        status: CreateVerifiedDomainsResponseStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(CreateVerifiedDomainsResponseStatus.self, forKey: .status)
