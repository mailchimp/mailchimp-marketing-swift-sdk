...
public struct ListMembersStats: Codable, Hashable, Sendable {
    /// A subscriber's average clickthrough rate.
    public let avgClickRate: Double?
    /// A subscriber's average open rate.
    public let avgOpenRate: Double?
    /// Ecommerce stats for the list member if the list is attached to a store.
    public let ecommerceData: ListMembersStatsEcommerceData?
    ...
    public init(
        ...
        ecommerceData: ListMembersStatsEcommerceData? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.ecommerceData = try container.decodeIfPresent(ListMembersStatsEcommerceData.self, forKey: .ecommerceData)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeIfPresent(self.ecommerceData, forKey: .ecommerceData)
    }
