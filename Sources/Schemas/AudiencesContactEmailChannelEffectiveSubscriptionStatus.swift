...
public struct AudiencesContactEmailChannelEffectiveSubscriptionStatus: Codable, Hashable, Sendable {
    public let value: AudiencesContactEmailChannelEffectiveSubscriptionStatusValue?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        value: AudiencesContactEmailChannelEffectiveSubscriptionStatusValue? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.value = try container.decodeIfPresent(AudiencesContactEmailChannelEffectiveSubscriptionStatusValue.self, forKey: .value)
