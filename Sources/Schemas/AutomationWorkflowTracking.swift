...
public struct AutomationWorkflowTracking: Codable, Hashable, Sendable {
    /// Deprecated
    public let capsule: AutomationWorkflowTrackingCapsule?
    ...
    /// Deprecated
    public let salesforce: AutomationWorkflowTrackingSalesforce?
    ...
    public init(
        capsule: AutomationWorkflowTrackingCapsule? = nil,
        ...
        htmlClicks: Bool? = nil,
        opens: Bool? = nil,
        salesforce: AutomationWorkflowTrackingSalesforce? = nil,
        textClicks: Bool? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.capsule = try container.decodeIfPresent(AutomationWorkflowTrackingCapsule.self, forKey: .capsule)
        ...
        self.salesforce = try container.decodeIfPresent(AutomationWorkflowTrackingSalesforce.self, forKey: .salesforce)
