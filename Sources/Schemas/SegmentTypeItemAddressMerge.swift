...
public struct SegmentTypeItemAddressMerge: Codable, Hashable, Sendable {
    ...
    public let op: SegmentTypeItemAddressMergeOp
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.op = try container.decode(SegmentTypeItemAddressMergeOp.self, forKey: .op)
