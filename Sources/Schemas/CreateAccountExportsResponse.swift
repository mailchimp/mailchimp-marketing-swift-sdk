...
/// An account export.
public struct CreateAccountExportsResponse: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [CreateAccountExportsResponseLinksItem]?
    ...
    public init(
        links: [CreateAccountExportsResponseLinksItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([CreateAccountExportsResponseLinksItem].self, forKey: .links)
