...
public struct CampaignDeliveryStatus: Codable, Hashable, Sendable {
    ...
    public let status: CampaignDeliveryStatusStatus?
    ...
    public init(
        ...
        emailsSent: Int? = nil,
        enabled: Bool? = nil,
        status: CampaignDeliveryStatusStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(CampaignDeliveryStatusStatus.self, forKey: .status)
