...
public struct CampaignsRecipientsSegmentOpts: Codable, Hashable, Sendable {
    public let conditions: SegmentType?
    /// Segment match type.
    public let match: CampaignsRecipientsSegmentOptsMatch?
    /// The prebuilt segment id, if a prebuilt segment has been designated for this campaign.
    public let prebuiltSegmentId: String?
    /// The id for an existing saved segment.
    public let savedSegmentId: CampaignsRecipientsSegmentOptsSavedSegmentId?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        conditions: SegmentType? = nil,
        match: CampaignsRecipientsSegmentOptsMatch? = nil,
        prebuiltSegmentId: String? = nil,
        savedSegmentId: CampaignsRecipientsSegmentOptsSavedSegmentId? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.match = try container.decodeIfPresent(CampaignsRecipientsSegmentOptsMatch.self, forKey: .match)
        self.prebuiltSegmentId = try container.decodeIfPresent(String.self, forKey: .prebuiltSegmentId)
        self.savedSegmentId = try container.decodeIfPresent(CampaignsRecipientsSegmentOptsSavedSegmentId.self, forKey: .savedSegmentId)
