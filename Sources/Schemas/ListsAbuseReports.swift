...
public struct ListsAbuseReports: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [ListsAbuseReportsLinksItem]?
    ...
    public let mergeFields: [String: ListsAbuseReportsMergeFieldsValue]?
    ...
    public init(
        links: [ListsAbuseReportsLinksItem]? = nil,
        ...
        id: Int? = nil,
        listId: String? = nil,
        mergeFields: [String: ListsAbuseReportsMergeFieldsValue]? = nil,
        vip: Bool? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([ListsAbuseReportsLinksItem].self, forKey: .links)
        ...
        self.mergeFields = try container.decodeIfPresent([String: ListsAbuseReportsMergeFieldsValue].self, forKey: .mergeFields)
