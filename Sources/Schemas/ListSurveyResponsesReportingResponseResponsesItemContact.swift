...
public struct ListSurveyResponsesReportingResponseResponsesItemContact: Codable, Hashable, Sendable {
    ...
    public let status: ListSurveyResponsesReportingResponseResponsesItemContactStatus?
    ...
    public init(
        ...
        fullName: String? = nil,
        phone: String? = nil,
        status: ListSurveyResponsesReportingResponseResponsesItemContactStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decodeIfPresent(ListSurveyResponsesReportingResponseResponsesItemContactStatus.self, forKey: .status)
