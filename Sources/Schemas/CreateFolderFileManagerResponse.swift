...
public struct CreateFolderFileManagerResponse: Codable, Hashable, Sendable {
    /// A list of link types and descriptions for the API schema documents.
    public let links: [CreateFolderFileManagerResponseLinksItem]?
    ...
    public init(
        links: [CreateFolderFileManagerResponseLinksItem]? = nil,
        createdAt: Date? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent([CreateFolderFileManagerResponseLinksItem].self, forKey: .links)
