...
public struct CampaignVariateSettings: Codable, Hashable, Sendable {
    /// Combinations of possible variables used to build emails.
    public let combinations: [CampaignVariateSettingsCombinationsItem]?
    ...
    public let winnerCriteria: CampaignVariateSettingsWinnerCriteria
    ...
    public init(
        combinations: [CampaignVariateSettingsCombinationsItem]? = nil,
        contents: [String]? = nil,
        ...
        testSize: Int? = nil,
        waitTime: Int? = nil,
        winnerCriteria: CampaignVariateSettingsWinnerCriteria,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.combinations = try container.decodeIfPresent([CampaignVariateSettingsCombinationsItem].self, forKey: .combinations)
        ...
        self.winnerCriteria = try container.decode(CampaignVariateSettingsWinnerCriteria.self, forKey: .winnerCriteria)
