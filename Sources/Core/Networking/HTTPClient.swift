...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw MailchimpError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw MailchimpError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: MailchimpError?
                ...
                } else if let existingClientError = error as? MailchimpError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw MailchimpError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> MailchimpError
    {
        ...
        return MailchimpError.httpError(httpError)
    }
}
