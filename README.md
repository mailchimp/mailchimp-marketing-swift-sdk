...
```swift
dependencies: [
    .package(url: "https://github.com/mailchimp/mailchimp-marketing-swift-sdk", from: "0.0.219"),
]
```

## Reference

A full reference for this library is available [here](https://github.com/mailchimp/mailchimp-marketing-swift-sdk/blob/HEAD/./reference.md).
...
} catch let error as MailchimpError {
    switch error {
...
let request = Requests.CreateAccountExportsRequest(
    ...
)
```
...
```swift
try await client.accountExports.create(..., requestOptions: .init(
    additionalHeaders: [
